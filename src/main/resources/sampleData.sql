...
insert into HOLIDAY (ENGINEER_ID, HOLIDAY_START_DATE, HOLIDAY_END_DATE) values ((SELECT ENGINEER_ID FROM ENGINEER WHERE NAME = 'John Smith'), '2021-04-02', '2021-04-05');